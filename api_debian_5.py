...
for information in json_debian:
    ...
    for a in json_debian[package]:
        ...
        select = f"SELECT CVE from debian2 WHERE CVE = '{idcve}'"
            ...
            for x in records:
                ...
                for b in json_debian[package][idcve]["releases"]:
                    ...
                    if status == "resolved":
                        ...
                        # Write to DataBase
                        sql = "INSERT INTO debian2 (CVE, Published_NIST, Severity_NIST, Priority, Package, Distro, Status, Version_Resolved, Resolved) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
                        ...
                        priority = str((json_debian[package][idcve]["releases"][distro]["urgency"]))
                        # Write to DataBase
                        sql = "INSERT INTO debian2 (CVE, Published_NIST, Severity_NIST, Priority, Package, Distro, Status) VALUES (%s, %s, %s, %s, %s, %s, %s)"
